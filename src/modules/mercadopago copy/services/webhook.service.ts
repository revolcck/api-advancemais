...
import { IWebhookProcessorService } from "../interfaces/services.interface";
import {
  WebhookNotification,
 ...
 */
export class WebhookService implements IWebhookProcessorService {
  /**
  ...
  public async processWebhook(
    ...
    try {
      ...
      if (!isValid) {
        ...
        // Para webhooks de teste, tratamos com mais flexibilidade
